		...
		>
			{#if isExternalKnowledge}
				<div class="p-5 flex flex-col gap-4">
					...
					<div class="text-xs text-gray-500">
						{$i18n.t(
							'This knowledge base retrieves from a connected source. Nuobao Infinity can query it, but cannot upload, sync, edit, delete, reset, or reindex its source data.'
						)}
					</div>
