		...
		<AdminSettingSection title={$i18n.t('LDAP')}>
			...
			{#if ENABLE_LDAP}
				...
				<AdminSettingRow
					...
					description={$i18n.t('Map LDAP groups to Nuobao Infinity groups.')}
					let:labelId
				>
			...
			<AdminSettingSection title={$i18n.t('OAuth / OIDC')}>
				...
				{#if oauthConfig.ENABLE_OAUTH}
					...
					<AdminSettingRow
						...
						description={$i18n.t('Map OAuth claims to Nuobao Infinity roles.')}
						let:labelId
					>
						<Switch
					...
					<AdminSettingRow
						label={$i18n.t('Group Mapping')}
						description={$i18n.t('Map OAuth claims to Nuobao Infinity groups.')}
						let:labelId
					>
						<Switch
