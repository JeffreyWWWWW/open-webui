...
# can't be a legitimate Nuobao LLM collection name.
...
class MilvusClient(VectorDBBase):
    ...
    def _get_collection_and_resource_id(self, collection_name: str) -> Tuple[str, str]:
        ...
        WARNING: This mapping relies on current Nuobao LLM naming conventions for
        collection names. If Nuobao LLM changes how it generates collection names
