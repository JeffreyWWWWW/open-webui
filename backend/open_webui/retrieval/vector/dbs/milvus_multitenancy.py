...
# can't be a legitimate Nuobao Infinity collection name.
...
class MilvusClient(VectorDBBase):
    ...
    def _get_collection_and_resource_id(self, collection_name: str) -> Tuple[str, str]:
        ...
        WARNING: This mapping relies on current Nuobao Infinity naming conventions for
        collection names. If Nuobao Infinity changes how it generates collection names
